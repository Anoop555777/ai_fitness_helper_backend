...
const DB =
  ...
  "mongodb://localhost:27017/fitness-form-helper";
...
// Bind to 0.0.0.0 in cloud environments (Render, Heroku, etc.) to allow external connections
// Render always sets PORT, so if PORT is set and HOST is not explicitly set, use 0.0.0.0
// Use localhost only in local development when PORT is not set
